      ...
      <div class="container-xxl position-relative p-0">
        ...
        >
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="booking.php" class="btn btn-primary py-2 px-4">Masa rezerve et</a>
            ...
            <div class="row align-items-center g-5">
              <div class="col-lg-6 text-center text-lg-start">
                <h1 class="display-3 text-white animated slideInLeft">
                  Lezzetli Yemeklerimizin<br />Tadını Çıkarın
                </h1>
                <p class="text-white animated slideInLeft mb-4 pb-2">
                  Dünyanın seçkin aşçıları tarafından hazırlanan eşsiz
                  lezzetlerimizi tadın. Başka ülkelere gitmeden bütün lezzetleri
                  ayağınıza getirdik, menümüzde topladık.
                </p>
                <a
                  href="menu.php"
                  class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft"
                  >menümüzü görüntüleyİn</a
                >
              </div>
              <div class="col-lg-6 text-center text-lg-end overflow-hidden">
                <img class="img-fluid" src="img/EtvePilav.jpg" alt="" />
              </div>
            </div>
          </div>
        </div>
